...
mp.moveWithButtons(mp.playerSelector(mp.PlayerNumber.Two), 52, 52)
mp.moveWithButtons(mp.playerSelector(mp.PlayerNumber.One), 52, 52)
music.play(music.stringPlayable("C5 A D - E B C E ", 120), music.PlaybackMode.InBackground)
let statusbar = sprites.create(assets.image`myImage1`, SpriteKind.StatusBar)
